...
SkyLights_U = 3
Window_U_Flat = 1.6
Ceiling_U_Flat_Main = .14
Ceiling_U_Flat_Bathroom = .25
Wall_U_Flat_Main = .29
Wall_U_Flat_Bathroom = .3
...
HouseList = [Dan, Jen, Bryony, Sophie, SarahL, Tim, Nels, DSK, USK, LivingRoom, DSHall, USHAll, DSB]
